...
function ProductDetails({ product }: ProductDetailsProps) {
  ...
  const costPrice = Number.parseFloat(product.cost_price);
  const sellingPrice = Number.parseFloat(product.selling_price);
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button
            variant="outline"
            onClick={() => router.push(`/inventory/edit-product/${product.id}`)}
          >
